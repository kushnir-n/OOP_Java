...
public class Main {
    public static void main(String[] args) {        
        ...
        */
        ...
        ArrayList<Hero> team1 = service.generateTeam(8, 0, 1);
        ArrayList<Hero> team2 = service.generateTeam(8, 9, 2);
        ...
        for (Hero hero : team1) {
            ...
            if (hero instanceof Crossbower) {
                System.out.println(((Crossbower)hero).findNearestEnemy(team2));
            }
            hero.step();
        }
        ...
        for (Hero hero : team2) {
            hero.attack("Aaaaa!");
            if (hero instanceof Crossbower) {
                System.out.println(((Crossbower)hero).findNearestEnemy(team1));
            }
            hero.step();
        }
    }

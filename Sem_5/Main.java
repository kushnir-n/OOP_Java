...
/* MyView */
        ...
        team1 = service.generateTeam(VIKINGS_COUNT, 1, 1);
        team2 = service.generateTeam(VIKINGS_COUNT, DISTANCE, 2);
...
/* View */
        ...
        //teams = service.combineTeams(team1, team2);
        //service.battleVikings2(team1, team2);
    }
}

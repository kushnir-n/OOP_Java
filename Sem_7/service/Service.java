...
public class Service {
    ...
    public void printTeamsInfo(ArrayList<Hero> team1, ArrayList<Hero> team2) {
        for (Hero hero : team1) {
            ...
            System.out.printf("%s. Ближайший враг на позиции (%d, %d)%n", hero, nearestEnemyPosition.getX(), nearestEnemyPosition.getY());
        }
        for (Hero hero : team2) {
    ...
    private void teamsTurn(ArrayList<Hero> team1, ArrayList<Hero> team2) {
        for (Hero hero : team1) {
            if (!team2.isEmpty()) {
